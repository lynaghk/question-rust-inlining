; ModuleID = 'match_mix.3a1fbbbh-cgu.0'
source_filename = "match_mix.3a1fbbbh-cgu.0"
...
; match_mix::match_mix_4
; Function Attrs: nounwind readonly uwtable
define i64 @_ZN9match_mix11match_mix_417hc24e59bd284f58e7E([0 x i8]* noalias nonnull readonly %s.0, i64 %s.1) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception"*, %"unwind::libunwind::_Unwind_Context"*)* @rust_eh_personality {
start:
...
bb1.i:                                            ; preds = %bb6, %bb15
  %out.160 = phi i64 [ %out.062, %bb6 ], [ %18, %bb15 ]
...
bb9.i.i.i:                                        ; preds = %bb1.i.i
  ...
  br label %"_ZN76_$LT$core..iter..Take$LT$I$GT$$u20$as$u20$core..iter..iterator..Iterator$GT$4next17h1e1754e18b539e81E.exit"
...
"_ZN76_$LT$core..iter..Take$LT$I$GT$$u20$as$u20$core..iter..iterator..Iterator$GT$4next17h1e1754e18b539e81E.exit": ; preds = %bb9.i.i.i, %bb8.i.i.i
...
bb14:                                             ; preds = %bb2.i.i, %bb1.i.i, %bb15, %"_ZN76_$LT$core..iter..Take$LT$I$GT$$u20$as$u20$core..iter..iterator..Iterator$GT$4next17h1e1754e18b539e81E.exit"
  %out.1.lcssa = phi i64 [ %out.160, %bb2.i.i ], [ %out.160, %bb1.i.i ], [ %18, %bb15 ], [ %out.160, %"_ZN76_$LT$core..iter..Take$LT$I$GT$$u20$as$u20$core..iter..iterator..Iterator$GT$4next17h1e1754e18b539e81E.exit" ]
  %exitcond = icmp eq i64 %3, 1000
  br i1 %exitcond, label %bb4, label %bb6

bb15:                                             ; preds = %"_ZN76_$LT$core..iter..Take$LT$I$GT$$u20$as$u20$core..iter..iterator..Iterator$GT$4next17h1e1754e18b539e81E.exit"
  ...
  %19 = icmp eq i64 %4, 0
  br i1 %19, label %bb14, label %bb1.i
}
